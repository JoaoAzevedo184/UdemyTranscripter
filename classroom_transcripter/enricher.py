...
class LLMProvider(ABC):
    ...
    # ─── #1: Lógica de retry extraída para método base ───────────────────
    ...
    def _post_with_retry(
        ...
        Centraliza a lógica de espera/retentativa que antes era duplicada
        em GroqProvider e GeminiProvider.
        ...
        Args:
            ...
            max_retries: Número máximo de retentativas após 429.
            provider_label: Nome do provider para mensagens de log.

        Returns:
            Dicionário com o JSON de resposta da API.

        Raises:
            RuntimeError: Se a requisição falhar após todas as tentativas.
        """
        import requests
...
class ClaudeProvider(LLMProvider):
    ...
    def __init__(
        ...
        model: str = "claude-sonnet-4-6",  # #2: model string atualizado
    ):
...
class GroqProvider(LLMProvider):
    ...
    def complete(self, system: str, user: str) -> str:
        # #1: usa _post_with_retry em vez de lógica de retry inline
